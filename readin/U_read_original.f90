...
character::dateyear(540)*8,year*4,month*2,datenow*8
...
! U(:,:,:)=Ut(3361:4000,800:1321,1:30,1)*scale_factor1+add_offset1
! open(7,file='/Volumes/erika/CMEMS/processed_data/U/U_'//datenow//'.dat')
! do k=1,ll
!      do j=1,lj
!           do i=1,li
