...
open(8,file='/Volumes/erika/CMEMS/set_input/grid_mask_bathy.dat')
! write(8,*)((H(i,j), i = 1, li), j = 1, lj)
! write(8,*)((LEV(i,j), i = 1, li), j = 1, lj)
! write(8,*)(((MASK(i, j, k), i = 1, li), j = 1, lj),k = 1, ll)
write(8,*)((H(i,j), i = 1, LN), j = 1, JN)
write(8,*)((LEV(i,j), i = 1,LN ), j = 1, JN)
write(8,*)(((MASK(i, j, k), i = 1, LN), j = 1, JN),k = 1, DD)
close(8)


open(9,file='/Volumes/erika/CMEMS/set_input/grid_lonlat.dat',status='replace')
write(9,*)(lon(i), i = 1, LN)
write(9,*)(lat(j), j = 1, JN)
close(9)

end program read_grid
