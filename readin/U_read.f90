! gfortran U_read.f90 -L/usr/local/Cellar/netcdf/4.8.1/lib -lnetcdff
program main
...
U(1:720,:,:)=Ut(3601:4320,241:1201,1:30,1)*scale_factor1+add_offset1
U(721:1081,:,:)=Ut(1:361,241:1201,1:30,1)*scale_factor1+add_offset1
open(7,file='/Volumes/erika/CMEMS/south_pacific/U/U_'//datenow//'.dat')
do k=1,ll
     do j=1,lj
          do i=1,li
